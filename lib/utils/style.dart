...
class Styles{
  ...
  static TextStyle headlineStyle5 = TextStyle(fontSize: 16, color: Colors.grey.shade500, fontWeight: FontWeight.w500);
  static TextStyle links = const TextStyle(fontSize: 14, color: Color(0xFFCD5C5C), fontWeight: FontWeight.w500);
}
